...
printf(1, "It is always fun to work with xv6\n");
  1d:	58                   	pop    %eax
  1e:	5a                   	pop    %edx
  1f:	68 f8 06 00 00       	push   $0x6f8
  24:	6a 01                	push   $0x1
  26:	e8 95 03 00 00       	call   3c0 <printf>
exit();
  2b:	e8 42 02 00 00       	call   272 <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 35f:	f7 f6                	div    %esi
 361:	0f b6 92 24 07 00 00 	movzbl 0x724(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 4d8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 4db:	b8 1c 07 00 00       	mov    $0x71c,%eax
...
free(void *ap)
{
 ...
 561:	a1 bc 09 00 00       	mov    0x9bc,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5b7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5b9:	a3 bc 09 00 00       	mov    %eax,0x9bc
}
 5be:	5b                   	pop    %ebx
 5bf:	5e                   	pop    %esi
 5c0:	5f                   	pop    %edi
 ...
 5da:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 5dd:	a3 bc 09 00 00       	mov    %eax,0x9bc
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 5f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 5fc:	8b 15 bc 09 00 00    	mov    0x9bc,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 64f:	76 3f                	jbe    690 <malloc+0xa0>
    ...
    if(p == freep)
 651:	39 05 bc 09 00 00    	cmp    %eax,0x9bc
 ...
 676:	e8 e5 fe ff ff       	call   560 <free>
  return freep;
 67b:	8b 15 bc 09 00 00    	mov    0x9bc,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 69c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 69f:	89 15 bc 09 00 00    	mov    %edx,0x9bc
      return (void*)(p + 1);
 ...
 6b4:	eb e9                	jmp    69f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6b6:	c7 05 bc 09 00 00 c0 	movl   $0x9c0,0x9bc
 6bd:	09 00 00 
 6c0:	c7 05 c0 09 00 00 c0 	movl   $0x9c0,0x9c0
 6c7:	09 00 00 
    base.s.size = 0;
 6ca:	b8 c0 09 00 00       	mov    $0x9c0,%eax
 6cf:	c7 05 c4 09 00 00 00 	movl   $0x0,0x9c4
 6d6:	00 00 00 
