...
printf(1, "My first user program in xv6\n");
...
free(void *ap)
{
 ...
 561:	a1 a0 09 00 00       	mov    0x9a0,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5b7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5b9:	a3 a0 09 00 00       	mov    %eax,0x9a0
}
 5be:	5b                   	pop    %ebx
 5bf:	5e                   	pop    %esi
 5c0:	5f                   	pop    %edi
 ...
 5da:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 5dd:	a3 a0 09 00 00       	mov    %eax,0x9a0
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 5f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 5fc:	8b 15 a0 09 00 00    	mov    0x9a0,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 64f:	76 3f                	jbe    690 <malloc+0xa0>
    ...
    if(p == freep)
 651:	39 05 a0 09 00 00    	cmp    %eax,0x9a0
 ...
 676:	e8 e5 fe ff ff       	call   560 <free>
  return freep;
 67b:	8b 15 a0 09 00 00    	mov    0x9a0,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 69c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 69f:	89 15 a0 09 00 00    	mov    %edx,0x9a0
      return (void*)(p + 1);
 ...
 6b4:	eb e9                	jmp    69f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6b6:	c7 05 a0 09 00 00 a4 	movl   $0x9a4,0x9a0
 6bd:	09 00 00 
 6c0:	c7 05 a4 09 00 00 a4 	movl   $0x9a4,0x9a4
 6c7:	09 00 00 
    base.s.size = 0;
 6ca:	b8 a4 09 00 00       	mov    $0x9a4,%eax
 6cf:	c7 05 a8 09 00 00 00 	movl   $0x0,0x9a8
 6d6:	00 00 00 
